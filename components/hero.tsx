    ...
    <section className="relative overflow-hidden bg-background text-foreground">
      <div className="mx-auto grid min-h-[calc(100svh-5rem)] max-w-[1600px] lg:grid-cols-[0.95fr_1.05fr]">
        <div className="flex flex-col justify-center px-6 py-20 sm:px-10 lg:px-16 xl:px-20">
          <p className="mb-8 inline-flex w-fit items-center gap-3 rounded-full border border-background/40 px-4 py-2 text-[10px] uppercase tracking-[0.3em] text-foreground/75">
            <span aria-hidden="true" className="text-foreground/80">✦</span> Santa Catalina · Montevideo
          </p>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            ...
            <a href="#barberos" className="inline-flex min-h-12 items-center justify-center rounded-full border border-background/25 px-7 py-3 text-sm font-medium text-foreground transition-colors hover:border-background hover:bg-background/10">
              Ver barberos
            </a>
          </div>
          <ul className="mt-10 flex flex-wrap gap-x-6 gap-y-3 text-xs text-foreground/60" aria-label="Beneficios de Corte Fino">
            <li className="flex items-center gap-2"><span className="text-foreground/80">✓</span> Agenda online</li>
            <li className="flex items-center gap-2"><span className="text-foreground/80">✓</span> Atención personalizada</li>
            <li className="flex items-center gap-2"><span className="text-foreground/80">✓</span> Profesionales calificados</li>
          </ul>
        </div>
        <div className="relative min-h-[28rem] overflow-hidden border-l border-background/10 lg:min-h-full">
          ...
          <div className="absolute inset-x-5 bottom-5 flex items-center justify-between gap-3 rounded-2xl border border-background/20 bg-background/75 p-3 backdrop-blur-md sm:inset-x-8 sm:bottom-8 sm:p-4">
